...
flags = tf.app.flags
flags.DEFINE_string('output_path', 'train.record', '') #'I:/SDCND/SDCND/term3/SystemIntegration/CarND-Capstone-master/ros/src/tl_detector/light_classification/data/bosch/dataset_train_rgb/train.record')
FLAGS = flags.FLAGS
